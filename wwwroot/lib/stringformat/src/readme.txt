...
stringformat-1.10.min.js    - Compressed and obfuscated, to be used in production.
stringformat-1.10.js        - Commented source file for your reference.
...
culture will be used.
    ...
    [CODE]
    <script type="text/javascript" src="stringformat-1.10.min.js"></script>
